...
import os
import unittest
from ApiTest import (exceptions, loader, logger, parser, report, runner,
                        utils, validator)
...
if __name__ == '__main__':
    # HttpRunner().run()
    HttpRunner().run_path(path=r'C:\Users\lilingyun01\Desktop\test_yaml\yaml_practice\udisk.yaml')
