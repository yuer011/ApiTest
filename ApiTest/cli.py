...
def main_hrun():
    ...
    """
    import argparse
    from ApiTest import logger
    from ApiTest.__about__ import __description__, __version__
    from ApiTest.api import HttpRunner
    from ApiTest.compat import is_py2
    from ApiTest.utils import (create_scaffold, get_python2_retire_msg,
