...
import yaml
from ApiTest import exceptions, logger, parser, utils, validator
...
def __extend_with_api_ref(raw_testinfo):
    ...
    # print('!!!!!!!',api_name)
    # 'C:\Users\lilingyun01\Desktop\test_yaml\yaml_practice\case\AK_udisk\udisk2.yml'
    # >>!!!!!!! api/api_udisk_reg.yml
...
if __name__ == '__main__':
    ...
    # print(load_dot_env_file(r'C:\Users\lilingyun01\Desktop\test_yaml\yaml_practice\.env'))