...
import requests
from ApiTest import loader, logger
from ApiTest.__about__ import __version__
from ApiTest.compat import basestring, bytes, json, numeric_types
...
def render_html_report(summary, report_template=None, report_dir=None):
    ...
    with open(report_template, "r", encoding='utf-8') as fp_r:
    ...
    os.system("open {}".format(report_path))
