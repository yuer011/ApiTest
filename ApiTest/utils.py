...
from ApiTest import exceptions, logger
from ApiTest.compat import basestring, bytes, is_py2
from ApiTest.exceptions import ParamsError
...
def set_os_environ(variables_mapping):
    ...
    for variable in variables_mapping:
        if variable in os.environ:
            logger.log_debug("Skip set OS environment variable: {}".format(variable))
            continue
...
def _convert_validators_to_mapping(validators):
    ...
    # print('validators_mapping',validators_mapping)
...
def extend_variables(raw_variables, override_variables):
    ...
    if not raw_variables:
        ...
        print('else raw_variables_mapping',raw_variables_mapping)
        return raw_variables_mapping
